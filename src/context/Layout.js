...
import { funcAuth_setData, funcAuth_updateData } from "../context/Functions_Auth";
                    ...
                    <tr>
                        ...
                        <td style={{width:"90px"}}>
                            <div style={{display:"flex", alignItems:"center", justifyContent:"space-between"}}>
                                ...
                                <svg id="profile" onClick={()=>navigate('/profile')} onMouseOver={e=>e.currentTarget.style.backgroundColor='var(--monochromaticWhite)'} onMouseOut={e=>e.currentTarget.style.backgroundColor=''}
                                ...
                                <div className="dropdown" onMouseOver={e=>e.currentTarget.style.backgroundColor='var(--monochromaticWhite)'} onMouseOut={e=>e.currentTarget.style.backgroundColor=''}
                                    ...
                                    <div className='dropdown-menu' style={{position:'absolute', borderRadius:'5px', padding:'2px', top:'130%', right:0, boxShadow:'0px 2px 5px 0px #8888', backgroundColor:'white',width:'4rem', zIndex:1}}>
                                        ...
                                        <div onClick={()=>navigate('/autoconfig')} onMouseOver={e=>e.currentTarget.style.backgroundColor = 'var(--thir-backgroundColor)'} onMouseOut={e=>e.currentTarget.style.backgroundColor = 'var(--sec-backgroundColor)'}
                                        ...
                                        {/* Clear Logs */}
                                        <div onClick={()=>{setLogArray([]); func_snackbar(reference,'Logs Cleared')}} onMouseOver={e=>e.currentTarget.style.backgroundColor = 'var(--thir-backgroundColor)'} onMouseOut={e=>e.currentTarget.style.backgroundColor = 'var(--sec-backgroundColor)'}
                                            style={{display:'flex', flexDirection:'column', justifyContent:'center', alignItems:'center',width:'100%', backgroundColor:'var(--sec-backgroundColor)', boxShadow:'var(--main-boxShadow)', cursor:'pointer', padding:'5px', borderRadius:'5px', marginTop:'5px'}}>
