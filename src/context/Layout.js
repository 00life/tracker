...
function Layout({children}) {
  ...
  return (
    <div ref={reference} style={{backgroundColor:'var(--main-backgroundColor)'}}>
                ...
                <tbody>
                    <tr>
                        <td style={{width:'100%', display:'flex', alignItems:'center'}}>
                            <img src={require("./../images/logo.png")} alt="logo" height="50px" width="max-width" onClick={()=>handleLogo()}
        ...
        <nav style={{display:"flex",boxShadow:"var(--main-boxShadow)", height:"50px", backgroundImage: 'linear-gradient(to bottom right, white, cornsilk)', border:"2px solid grey", borderRadius:"5px", alignItems:"center", justifyContent:"space-between", padding:"8px"}}>
            ...
            <button id="home" data-dest="/" onClick={(e)=>handleButtonEvent(e)} style={{boxShadow:"var(--main-boxShadow)", height:"40px", width:"40px"}}>
            ...
            <button id="barcode" data-dest="/barcode" onClick={(e)=>handleButtonEvent(e)} style={{boxShadow:"var(--main-boxShadow)", height:"40px", width:"40px"}}>
            ...
            <button id="request" data-dest="/request" onClick={(e)=>handleButtonEvent(e)} style={{pointerboxShadow:"var(--main-boxShadow)", height:"40px", width:"40px"}}>
            ...
            <button id="addperson" data-dest="/addperson" onClick={(e)=>handleButtonEvent(e)} style={{boxShadow:"var(--main-boxShadow)", height:"40px", width:"40px"}}>
            ...
            <div>
                ...
                {!authstatus && <button id="login" onClick={()=>navigate('/login')} style={{boxShadow:"var(--main-boxShadow)", height:"40px", width:"40px"}}>
                ...
                {authstatus && <button onClick={()=>{func_logout();func_snackbar(reference, 'Logout Successful')}} style={{boxShadow:"var(--main-boxShadow)", height:"40px", width:"40px"}}>
