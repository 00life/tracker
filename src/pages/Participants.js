...
import { func3_stripStoragePersons } from '../context/Functions_3';
...
function Participants() {
  ...
  const handleSavePersons = () =>{
    ...
    func_savedata(persons,'participants',"/participants", reference)
    
    // Strips data and saves persons to localStorage
    func3_stripStoragePersons(persons);
  };

  const handleLoadPersons = () => {
    func_loaddata('/participants', setPersons, reference);
  };
