...
function EditPerson() {
    ...
    const handleSchedule = ()=>{
      ...
      if(editDetails === '' || editDetails === null || editDetails === undefined){
    ...
    const handleSavePerson = ()=>{
      ...
      let newPersonObj = {
        ...
        base64: onBase64,
        schedule: onSchedule.sort((a,b)=>parseFloat(a.starttime.replace(':','.'))-parseFloat(b.starttime.replace(':','.'))),
      };
      ...
      // Confirmation message
      func_snackbar(reference, 'Participant Updated')
