...
function BarTrack(){
    ...
    const handleViewParticipant = e => {
        ...
        let hash = e.currentTarget.previousSibling.children[1].children[0].dataset.hash;
                    ...
                    {outPeople.map((obj,i)=>(
                        <div key={i}>
                            <div style={{margin:'5px', position:'relative'}}>
                                ...
                                {/* Clickable Overlay */}
                                <div onClick={e=>handleViewParticipant(e)} style={{position:'absolute', borderRadius:'50%', top:'50%',left:'50%', transform:'translate(-50%,-50%)', height:'55px', width:'55px', cursor:'pointer'}}>&nbsp;</div>
                            </div>
                        </div>
                    ))} 
                </div>
